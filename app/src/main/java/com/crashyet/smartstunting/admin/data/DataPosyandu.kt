...
class DataPosyandu : AppCompatActivity() {
...
//        enableEdgeToEdge()
        setContentView(R.layout.admin_data_posyandu)
        ...
        val url = "https://smart-stunting.com/mobile-login?remember_token=$token&to=data_posyandu"
        webView.loadUrl(url)
    }
