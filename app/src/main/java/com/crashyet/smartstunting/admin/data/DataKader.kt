...
class DataKader : AppCompatActivity() {
...
//        enableEdgeToEdge()
        setContentView(R.layout.admin_data_kader)
        ...
        val url = "https://smart-stunting.com/mobile-login?remember_token=$token&to=data_kader"
        webView.loadUrl(url)
    }
