...
class AdminGiziActivity : AppCompatActivity() {
...
//        enableEdgeToEdge()
        setContentView(R.layout.activity_admin_gizi)
        ...
        val url = "https://smart-stunting.com/mobile-login?remember_token=$token&to=gizi"
        webView.loadUrl(url)
    }
